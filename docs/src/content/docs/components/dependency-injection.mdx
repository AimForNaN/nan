...
It is PSR-11 compatible and is highly inspired by the PHP league's [container](https://container.thephpleague.com/4.x/) system,
	with some of the fat cut off and some adjustments made to help improve performance and reduce redundancy.
